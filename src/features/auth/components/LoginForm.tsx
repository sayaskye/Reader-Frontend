...
export default function LoginForm() {
  ...
  return (
    <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
      ...
      {/* Submit button */}
      <button
        className="bg-primary hover:bg-primary/90 text-primary-foreground flex w-full items-center justify-center gap-2 rounded-xl py-4 font-bold shadow-lg transition-all active:scale-95 disabled:opacity-70"
        type="submit"
