  ...
  return (
    <div className="bg-card z-20 flex h-full w-16 flex-col items-center gap-6 py-8">
      <button className="group relative">
        ...
        <span className="bg-card text-primary text-ssm absolute top-1/2 right-full mr-4 -translate-y-1/2 rounded px-2 py-1 whitespace-nowrap opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
          Annotations
        </span>
      </button>
      <button className="group relative">
